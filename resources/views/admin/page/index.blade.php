            ...
            <div class="card-box">
                <div class="dropdown pull-right">
                    <div class="btn-group pull-right">
                        {{--@can('add_categories')--}}
                        {{--<a href="{{ route('pages.create') }}" class="btn btn-custom  waves-effect waves-light">--}}
                        {{--<span class="m-l-5"><i--}}
                        {{--class="fa fa-plus"></i> <span>{{trans('admin.add')}}</span> </span></a>--}}
                        {{--@endcan--}}
                    </div>
                </div>
                <h4 class="header-title m-t-0 m-b-30">@lang('admin.pages')</h4>
                    ...
                    <table class="table m-0  table-striped table-hover table-condensed" id="datatable-fixed-header">
                        ...
                        @foreach($pages as $pages)
                            <tr>
                                ...
                                <td>{!! substr($pages->{'value_'.session('lang')},0,80) !!}</td>
                                <td>
                                    {{--@can('edit_categories')--}}
