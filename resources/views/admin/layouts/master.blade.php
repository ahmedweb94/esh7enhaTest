...
<!-- CSRF Token -->
    ...
    <title>@lang('admin.dashboard') | @yield('title')</title>
    <!--Morris Chart CSS -->
...
{{--<!-- End Footer -->--}}
<!-- Modal -->
<div id="changeOrderStatus" class="modal fade" role="dialog">
...
<script type="text/javascript">
    ...
    $('body').on('click', '.removeElementByDestroy', function () {
        var id = $(this).attr('data-id');
        var $tr = $(this).closest($('#elementRow' + id).parent().parent());
        var url = $(this).attr('data-url');
        swal({
    ...
    $('body').on('click', '.publishProduct', function () {
        ...
        swal({
            title: "هل انت متأكد؟",
            text: "هل انت متأكد من تغيير حالة نشر المنتج؟",
            type: "info",
            showCancelButton: true,
            confirmButtonColor: "#DD6B55",
            confirmButtonText: "موافق",
                    ...
                    success: function (data) {
                        if (data.status == 200) {
                            ...
                            if (data.published != null) {
                                $('#productRow' + productId).removeClass('btn-danger').addClass('btn-success').html('إلغاء النشر');
                            } else {
                                $('#productRow' + productId).removeClass('btn-success').addClass('btn-danger').html('نشر');
                            }
